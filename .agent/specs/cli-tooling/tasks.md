...
- [x] Implementar `loadConfig` con defaults y validación
- [x] Implementar `startDevServer` con HTTP estático y SSE live-reload
- [x] Implementar inyección de snippet SSE en HTML
- [x] Implementar watch del outputDir con debounce
- [x] Implementar CLI `wcc build` (descubrir, compilar, escribir output)
- [x] Implementar CLI `wcc dev` (build + server + watch)
