...
<template>
  <div :style="{ color: textColor() }">
    Styled Text
      ...
      // Should NOT have patterns like: this._state.textColor: this._state.textColor
...
<template>
  <div :style="{ color: textColor(), fontSize: fontSize() + 'px' }">
    Styled Text
      ...
      // CRITICAL: Should NOT generate invalid syntax like: this._state.fontSize: this._state.fontSize
