...
<div class="card">
  <slot name="info" :name="userName">Default info</slot>
      ...
      // Phase 4: scoped slot effect removed — regex patterns no longer in generated code
...
<div>
  <slot name="data" :val="value">Default</slot>
      ...
      // Phase 4: scoped slot effect removed — optional parentheses regex no longer generated
      expect(output).not.toContain("(\\\\(\\\\))?");
...
<div>
  <slot name="profile" :firstName="firstName" :lastName="lastName">Default</slot>
      ...
      // Phase 4: scoped slot effect removed — prop resolution no longer generated
      expect(output).not.toContain('firstName: this._state.firstName');
      expect(output).not.toContain('lastName: this._state.lastName');
...
<div>
  <slot name="content" :data="data">Default</slot>
      ...
      // Phase 4: scoped slot effect removed — nullish coalescing no longer generated
...
<ul>
  <slot name="row" :item="item">Default</slot>
      ...
      // Phase 4: scoped slot effect removed — global flag regex no longer generated
