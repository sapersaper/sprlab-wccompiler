...
describe('BUG-0006: defineModel event naming - kebab-case convention', () => {
  ...
  it('should emit kebab-case events for single model', async () => {
...
<input model="username" />
      ...
      // camelCase event (usernameChange) is also emitted for Angular [(prop)] compatibility
...
<input model="agree" type="checkbox" />
      ...
      // All events should emit kebab-case
      expect(code).toContain("dispatchEvent(new CustomEvent('username-changed'");
...
<input model="firstName" />
      ...
      // camelCase variants also emitted for Angular compat
