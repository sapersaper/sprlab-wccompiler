/**
 * E2E tests for Angular 19 integration — Composition.
...
test.describe('Angular + WCC Composition', () => {
  ...
  test.describe('Test 18: wcc-parent with internal wcc-counter', () => {
    ...
    test('increment button updates parent count', async ({ page }) => {
      ...
      await expect(page.locator('text=Angular parentChanged:').first()).toContainText('4');
    });
  });
