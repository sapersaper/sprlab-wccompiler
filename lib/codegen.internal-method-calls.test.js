...
<button @click="{{ mainMethod }}">Click</button>
    ...
    // Should transform internal method call to this._state.helperMethod
...
<button @click="{{ updateValue }}">Update</button>
    ...
    expect(code).toMatch(/this\._processValue\(this\._state\.value\)/);
...
<div>
  <button @click="{{ sortBy('name') }}">Sort</button>
    ...
    expect(code).toMatch(/this\._handleSearch\(this\._state\.searchTerm\)/);
