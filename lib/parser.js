 ...
 */
const REACTIVE_CALLS = /\b(?:signal|computed|effect|watch|defineProps|defineEmits|defineComponent|templateRef|templateBindings|onMount|onDestroy)\s*[<(]/;
...
export async function parse(filePath) {
  ...
  const watchers = extractWatchers(sourceForExtraction);
