...
.card { padding: 16px; }
      ...
      expect(output).toContain('name: this._state.userName');
      expect(output).toContain('age: this._state.userAge');
...
<table>
  <slot name="cell" :data="rowData" :index="rowIndex" :selected="rowSelected"></slot>
      ...
      expect(output).toContain('data: this._state.rowData');
      expect(output).toContain('index: this._state.rowIndex');
      expect(output).toContain('selected: this._state.rowSelected');
