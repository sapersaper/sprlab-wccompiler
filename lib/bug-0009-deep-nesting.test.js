...
<div>
  ...
  // (this._state.this._state.x) introduced by the zero-runtime refactor. Needs implementation fix.
  it.skip('full deep nesting (6 levels) compiles to valid JS', async () => {
