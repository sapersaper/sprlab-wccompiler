...
describe('walkTree — text bindings', () => {
  ...
  it('assigns descriptive varNames (__text_{name})', () => {
    ...
    expect(bindings[0].varName).toMatch(/^__text_a/);
    expect(bindings[1].varName).toMatch(/^__text_b/);
  });
...
describe('walkTree — event bindings', () => {
  ...
  it('assigns descriptive varNames (__evt_{event}_{handler})', () => {
    ...
    expect(events[0].varName).toMatch(/^__evt_click_a/);
    expect(events[1].varName).toMatch(/^__evt_click_b/);
  });
