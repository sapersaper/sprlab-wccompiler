...
<div :class="theme() === 'light' ? 'light-theme' : 'dark-theme'">Test</div>
    ...
    // The ternary should be properly formed (BUG-0011 fix: strings are now correct)
    expect(code).toContain("'light-theme'");
    expect(code).toContain("'dark-theme'");
    expect(code).toContain("this._theme() === 'light'");
  });
