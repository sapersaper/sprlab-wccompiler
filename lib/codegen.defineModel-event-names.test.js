...
describe('BUG-0006: defineModel event naming - kebab-case convention', () => {
  ...
  it.skip('should emit events in kebab-case format for single model', async () => {
...
<input model="username" />
  ...
  it.skip('should emit kebab-case events for multiple models with different types', async () => {
    const dir = createTempDir();
    try {
      const sfcContent = `<script>
import { defineComponent, defineModel } from 'wcc'
...
<input model="agree" type="checkbox" />
  ...
  it.skip('should convert camelCase model names to kebab-case events', async () => {
    const dir = createTempDir();
    try {
      const sfcContent = `<script>
import { defineComponent, defineModel } from 'wcc'
