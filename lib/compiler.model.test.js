...
<textarea model="bio"></textarea>
      ...
      expect(output).toContain("this.__model_name_0.value = this._name() ?? ''");
      // Checkbox: !! coercion
      expect(output).toContain('this.__model_agreed_1.checked = !!this._agreed()');
      // Radio red: compare to 'red'
      expect(output).toContain("this.__model_color_2.checked = (this._color() === 'red')");
      // Radio blue: compare to 'blue'
      expect(output).toContain("this.__model_color_3.checked = (this._color() === 'blue')");
      // Number: value with nullish coalesce
      expect(output).toContain("this.__model_age_4.value = this._age() ?? ''");
      // Select: value with nullish coalesce
      expect(output).toContain("this.__model_category_5.value = this._category() ?? ''");
      // Textarea: value with nullish coalesce
      expect(output).toContain("this.__model_bio_6.value = this._bio() ?? ''");
