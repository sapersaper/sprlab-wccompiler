...
describe('compile() — show directive integration', () => {
  ...
  <button @click="toggle">Toggle</button>
      ...
      writeFileSync(
        join(dir, 'show-test.js'),
        `import { defineComponent, signal } from 'wcc'

export default defineComponent({
  tag: 'wcc-show-test',
  template: './show-test.html',
})
...
`
      ...
      const output = await compile(join(dir, 'show-test.js'));
...
`
      ...
      const output = await compile(join(dir, 'complex.js'));
