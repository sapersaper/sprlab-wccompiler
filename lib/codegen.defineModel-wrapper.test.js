...
<input model="name" />
      ...
      // Model binding writes directly to state (not through wrapper)
      expect(code).toContain('this._state.name = e.target.value');
...
<input model="email" type="email" />
      ...
      // Verify event listener writes directly to state
      expect(code).toContain("addEventListener('input'");
      expect(code).toContain('this._state.email = e.target.value');
...
<input model="enabled" type="checkbox" />
      ...
      // Verify change event listener writes directly to state
      expect(code).toContain("addEventListener('change'");
      expect(code).toContain('this._state.enabled = e.target.checked');
