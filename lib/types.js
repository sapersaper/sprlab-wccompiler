 ...
 * @property {string[]} path
 * @property {string} [staticValue] — Static class/style value from the element (if both static and dynamic exist)
 */
 ...
 * @property {ForBlock[]} [forBlocks] — Nested each directives within branch
 * @property {IfBlock[]} [ifBlocks] — Nested if/else-if/else chains within branch
 * @property {DynamicComponentBinding[]} [dynamicComponents] — Nested dynamic components within branch
 */

/**
 * @typedef {Object} IfBlock
 * @property {string} varName — Unique name: '__if0', '__if1', ...
 * @property {'if'|'each'|'dynamic'} anchorType — Anchor type identifier
 * @property {number} anchorIndex — Sequential anchor index
 ...
 * @property {DynamicComponentBinding[]} [dynamicComponents] — Nested dynamic components within item
 */
